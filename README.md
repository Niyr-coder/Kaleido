...
- **Actualización automática.** Con "Instalar actualizaciones automáticamente" (activa por defecto), al detectar una versión nueva Kaleido espera a que no estés en selección ni en partida, avisa con 15 segundos de cuenta atrás y se reinicia para instalarla. El lanzador tampoco pregunta al abrir. Con la casilla apagada aparece un aviso grande en el cliente con "Actualizar ahora" y "Más tarde".
- **Insignia de actualización.** Kaleido comprueba GitHub al arrancar y cada seis horas; si hay versión nueva aparece un "1" morado sobre el icono K del cliente, un aviso, y el botón "Actualizar ahora" ya listo en el panel. Se desactiva junto con "Buscar actualizaciones al iniciar".
